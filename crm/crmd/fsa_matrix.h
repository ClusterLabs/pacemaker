...
/* Got an I_NOT_DC */
	{
		...
		/* S_ELECTION		==> */	A_LOG|O_DC_TICKLE|A_DC_TIMER_STOP,
...
/* Got an I_JOIN_OFFER */
	{
		...
		/* S_NOT_DC		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP,
		/* S_POLICY_ENGINE	==> */	A_CL_JOIN_REQUEST,
		/* S_RECOVERY		==> */	O_RELEASE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP,
		/* S_RELEASE_DC		==> */	A_CL_JOIN_REQUEST|A_DC_TIMER_STOP,
		/* S_STARTING		==> */	A_LOG,
		/* S_PENDING		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP,
		/* S_STOPPING		==> */	A_LOG,
		/* S_TERMINATE		==> */	A_LOG,
