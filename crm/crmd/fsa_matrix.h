...
/* Got an I_WELCOME_ACK */
	{
		/* S_IDLE		==> */	A_JOIN_PROCESS_ACK|A_CIB_INVOKE|A_CIB_BUMPGEN,
		/* S_ELECTION		==> */	A_WARN,
		/* S_INTEGRATION	==> */	A_JOIN_PROCESS_ACK|A_CIB_INVOKE|A_CIB_BUMPGEN,
		/* S_NOT_DC		==> */	A_WARN,
		/* S_POLICY_ENGINE	==> */	A_JOIN_PROCESS_ACK|A_CIB_INVOKE|A_CIB_BUMPGEN,
		/* S_RECOVERY		==> */	A_WARN,
		/* S_RECOVERY_DC	==> */	A_JOIN_PROCESS_ACK|A_CIB_INVOKE|A_CIB_BUMPGEN,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_PENDING		==> */	A_WARN,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_JOIN_PROCESS_ACK|A_CIB_INVOKE|A_CIB_BUMPGEN,
	},
