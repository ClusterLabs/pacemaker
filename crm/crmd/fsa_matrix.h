...
/* Got an I_ELECTION_DC */
	{
		...
		/* S_ELECTION		==> */	A_LOG|A_DC_TAKEOVER|A_PE_START|A_TE_START|A_JOIN_WELCOME_ALL|A_DC_TIMER_STOP|A_ELECTION_VOTE,
...
/* Got an I_NODE_LEFT */
	{
		...
		/* S_ELECTION		==> */	A_WARN,
		/* S_INTEGRATION	==> */	A_PE_INVOKE,
		/* S_NOT_DC		==> */	A_DC_TIMER_START|A_WARN,
		/* S_POLICY_ENGINE	==> */	A_PE_INVOKE,
		/* S_RECOVERY		==> */	A_DC_TIMER_START|A_WARN,
		/* S_RECOVERY_DC	==> */	A_PE_INVOKE,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_PENDING		==> */	A_DC_TIMER_START|A_WARN,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
...
/* Got an I_NOT_DC */
	{
		...
		/* S_INTEGRATION	==> */	O_RELEASE|O_DC_TICKLE,
		/* S_NOT_DC		==> */	A_WARN,
		/* S_POLICY_ENGINE	==> */	O_RELEASE|O_DC_TICKLE,
		/* S_RECOVERY		==> */	A_WARN,
		/* S_RECOVERY_DC	==> */	O_RELEASE|O_DC_TICKLE,
		/* S_RELEASE_DC		==> */	O_RELEASE|O_DC_TICKLE,
		/* S_PENDING		==> */	A_WARN,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	O_RELEASE|O_DC_TICKLE,
	},
...
/* Got an I_SHUTDOWN */
	{
		/* S_IDLE		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_ELECTION		==> */	A_DC_TIMER_STOP|O_SHUTDOWN|O_RELEASE,
		/* S_INTEGRATION	==> */	A_DC_TIMER_STOP|O_SHUTDOWN|A_PE_STOP|A_TE_STOP|O_RELEASE,
		/* S_NOT_DC		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_POLICY_ENGINE	==> */	A_DC_TIMER_STOP|O_SHUTDOWN|A_PE_STOP|A_TE_STOP|O_RELEASE,
		/* S_RECOVERY		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_RECOVERY_DC	==> */	A_DC_TIMER_STOP|O_SHUTDOWN|A_PE_STOP|A_TE_STOP|O_RELEASE,
		/* S_RELEASE_DC		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_PENDING		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_STOPPING		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_TERMINATE		==> */	A_DC_TIMER_STOP|O_SHUTDOWN,
		/* S_TRANSITION_ENGINE	==> */	A_DC_TIMER_STOP|O_SHUTDOWN|A_PE_STOP|O_RELEASE,
	},
...
/* Got an I_WELCOME */
	{
		/* S_IDLE		==> */	O_RELEASE|A_JOIN_ACK,
		/* S_ELECTION		==> */	O_RELEASE|A_JOIN_ACK,
		/* S_INTEGRATION	==> */	O_RELEASE|A_JOIN_ACK,
		/* S_NOT_DC		==> */	O_DC_TICKLE|A_JOIN_ACK,
		/* S_POLICY_ENGINE	==> */	O_RELEASE|A_JOIN_ACK,
		/* S_RECOVERY		==> */	A_JOIN_ACK,
		/* S_RECOVERY_DC	==> */	O_RELEASE|A_JOIN_ACK,
		/* S_RELEASE_DC		==> */	A_JOIN_ACK,
		/* S_PENDING		==> */	O_DC_TICKLE|A_JOIN_ACK|A_STARTED,
		/* S_STOPPING		==> */	A_LOG,
		/* S_TERMINATE		==> */	A_LOG,
		/* S_TRANSITION_ENGINE	==> */	O_RELEASE|A_JOIN_ACK,
	},
