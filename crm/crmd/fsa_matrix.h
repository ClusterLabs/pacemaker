...
/* Got an I_DC_TIMEOUT */
	{
		...
		/* S_FINALIZE_JOIN	==> */	A_ELECTION_VOTE|A_ELECT_TIMER_START,
		...
		/* S_STOPPING		==> */	A_NOTHING,
		/* S_TERMINATE		==> */	A_NOTHING,
		/* S_TRANSITION_ENGINE	==> */	A_TE_CANCEL|A_ELECTION_VOTE|A_ELECT_TIMER_START,
	},
...
/* Got an I_ELECTION */
	{
		...
		/* S_FINALIZE_JOIN	==> */	A_ELECTION_COUNT,
...
/* Got an I_ELECTION_DC */
	{
		...
		/* S_ELECTION		==> */	A_LOG|A_DC_TAKEOVER|A_PE_START|A_TE_START|A_DC_JOIN_OFFER_ALL|A_ELECT_TIMER_STOP|A_ELECTION_VOTE,
		...
		/* S_PENDING		==> */	A_LOG|A_ELECTION_VOTE,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
...
/* Got an I_ERROR */
	{
		/* S_IDLE		==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
		/* S_ELECTION		==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
		/* S_INTEGRATION	==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
		/* S_FINALIZE_JOIN	==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
		/* S_NOT_DC		==> */	A_DC_TIMER_STOP|A_RECOVER,
		/* S_POLICY_ENGINE	==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
		/* S_RECOVERY		==> */	A_DC_TIMER_STOP|O_SHUTDOWN|O_RELEASE,
		...
		/* S_TRANSITION_ENGINE	==> */	A_DC_TIMER_STOP|A_RECOVER|O_RELEASE,
	},
...
/* Got an I_FAIL */
	{
		...
		/* S_RECOVERY		==> */	A_WARN|O_SHUTDOWN|O_RELEASE,
...
/* Got an I_NODE_JOIN */
	{
		...
		/* S_ELECTION		==> */	A_WARN,
		/* S_INTEGRATION	==> */	A_TE_CANCEL|A_DC_JOIN_OFFER_ONE,
		/* S_FINALIZE_JOIN	==> */	A_TE_CANCEL|A_DC_JOIN_OFFER_ONE,
		/* S_NOT_DC		==> */	A_WARN,
		/* S_POLICY_ENGINE	==> */	A_TE_CANCEL|A_DC_JOIN_OFFER_ONE,
		/* S_RECOVERY		==> */	A_WARN,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_PENDING		==> */	A_WARN,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_TE_CANCEL|A_DC_JOIN_OFFER_ONE,
	},
...
/* Got an I_NOT_DC */
	{
		...
		/* S_FINALIZE_JOIN	==> */	O_RELEASE|A_DC_TIMER_START,
		/* S_NOT_DC		==> */	A_WARN,
...
/* Got an I_RELEASE_FAIL */
	{
		...
		/* S_FINALIZE_JOIN	==> */	A_WARN|O_SHUTDOWN,
		/* S_NOT_DC		==> */	A_WARN,
...
/* Got an I_SHUTDOWN */
	{
		...
		/* S_RECOVERY		==> */	A_ELECT_TIMER_STOP|A_SHUTDOWN_REQ|O_RELEASE,
...
/* Got an I_STARTUP */
	{
		...
		/* S_RECOVERY		==> */	A_WARN,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_PENDING		==> */	A_LOG|A_STARTUP|A_CIB_START|A_LRM_CONNECT|A_CCM_CONNECT|A_HA_CONNECT|A_DC_TIMER_START|A_READCONFIG|A_STARTED,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_WARN,
	},
...
/* Got an I_JOIN_OFFER */
	{
		/* S_IDLE		==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_ELECTION		==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_INTEGRATION	==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_FINALIZE_JOIN	==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_NOT_DC		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST,
		/* S_POLICY_ENGINE	==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_RECOVERY		==> */	O_RELEASE|A_CL_JOIN_REQUEST,
		/* S_RELEASE_DC		==> */	A_CL_JOIN_REQUEST,
		/* S_PENDING		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST,
		/* S_STOPPING		==> */	A_LOG,
		/* S_TERMINATE		==> */	A_LOG,
		/* S_TRANSITION_ENGINE	==> */	O_RELEASE|A_CL_JOIN_REQUEST,
	},
...
/* Got an I_DC_HEARTBEAT */
	{
		...
		/* S_PENDING		==> */	A_LOG|O_DC_TICKLE|A_CL_JOIN_ANNOUNCE,
		/* S_STOPPING		==> */	A_NOTHING,
		/* S_TERMINATE		==> */	A_NOTHING,
		/* S_TRANSITION_ENGINE	==> */	A_WARN|A_ELECTION_VOTE,
	},
