...
/* Got an I_DC_TIMEOUT */
	{
		...
		/* S_RECOVERY		==> */	S_RECOVERY,
		/* S_RECOVERY_DC	==> */	S_RECOVERY_DC,
		/* S_RELEASE_DC		==> */	S_ELECTION,
		/* S_STARTING		==> */	S_ELECTION,
		/* S_STOPPING		==> */	S_STOPPING,
		/* S_TERMINATE		==> */	S_TERMINATE,
...
/* Got an I_RELEASE_SUCCESS */
	{
		/* S_IDLE		==> */	S_NOT_DC,
		/* S_ELECTION		==> */	S_NOT_DC,
		/* S_INTEGRATION	==> */	S_NOT_DC,
		/* S_NOT_DC		==> */	S_NOT_DC,
		/* S_POLICY_ENGINE	==> */	S_NOT_DC,
		/* S_RECOVERY		==> */	S_RECOVERY,
		/* S_RECOVERY_DC	==> */	S_RECOVERY,
...
/* Got an I_CCM_EVENT */
	{
		...
		/* S_STARTING		==> */	A_CCM_EVENT|A_CCM_UPDATE_CACHE,
		/* S_STOPPING		==> */	A_CCM_EVENT|A_CCM_UPDATE_CACHE,
		/* S_TERMINATE		==> */	A_CCM_EVENT|A_CCM_UPDATE_CACHE,
...
/* Got an I_CIB_UPDATE */
	{
		...
		/* S_ELECTION		==> */	A_CIB_INVOKE|A_PE_INVOKE,
		/* S_INTEGRATION	==> */	A_CIB_INVOKE|A_PE_INVOKE, // it should already be set
		/* S_NOT_DC		==> */	A_TICKLE_DC_TIMER|A_CIB_INVOKE,
		/* S_POLICY_ENGINE	==> */	A_CIB_INVOKE|A_PE_INVOKE,
		/* S_RECOVERY		==> */	A_TICKLE_DC_TIMER|A_CIB_INVOKE|A_NOTHING,
		/* S_RECOVERY_DC	==> */	A_CIB_INVOKE|A_PE_INVOKE,
		/* S_RELEASE_DC		==> */	A_TICKLE_DC_TIMER|A_CIB_INVOKE|A_NOTHING,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|A_CIB_INVOKE|A_NOTHING,
		/* S_STOPPING		==> */	A_CIB_INVOKE|A_NOTHING,
		/* S_TERMINATE		==> */	A_CIB_INVOKE|A_NOTHING,
...
/* Got an I_ELECTION_RELEASE_DC */
	{
		/* S_IDLE		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_ELECTION		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_INTEGRATION	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_NOT_DC		==> */	A_ERROR,
		/* S_POLICY_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_RECOVERY		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_RECOVERY_DC	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_RELEASE_DC		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|A_ERROR,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
	},
...
/* Got an I_ERROR */
	{
		/* S_IDLE		==> */	A_RECOVER,
		/* S_ELECTION		==> */	A_TICKLE_DC_TIMER|A_RECOVER,
		/* S_INTEGRATION	==> */	A_RECOVER,
		/* S_NOT_DC		==> */	A_TICKLE_DC_TIMER|A_RECOVER,
		/* S_POLICY_ENGINE	==> */	A_PE_RESTART|A_RECOVER,
		/* S_RECOVERY		==> */	O_SHUTDOWN,
		/* S_RECOVERY_DC	==> */	O_SHUTDOWN|O_RELEASE,
		/* S_RELEASE_DC		==> */	O_SHUTDOWN,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|O_SHUTDOWN,
		/* S_STOPPING		==> */	A_EXIT_1,
		/* S_TERMINATE		==> */	A_EXIT_1,
		/* S_TRANSITION_ENGINE	==> */	A_TE_RESTART|A_RECOVER,
	},
...
/* Got an I_NOT_DC */
	{
		...
		/* S_ELECTION		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_INTEGRATION	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_NOT_DC		==> */	A_TICKLE_DC_TIMER|A_WARN,
		/* S_POLICY_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_RECOVERY		==> */	A_TICKLE_DC_TIMER|A_WARN,
		/* S_RECOVERY_DC	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_RELEASE_DC		==> */	A_TICKLE_DC_TIMER|O_RELEASE,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|A_WARN,
		/* S_STOPPING		==> */	A_TICKLE_DC_TIMER|A_WARN,
		/* S_TERMINATE		==> */	A_TICKLE_DC_TIMER|A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE,
	},
...
/* Got an I_REQUEST */
	{
		...
		/* S_NOT_DC		==> */	A_TICKLE_DC_TIMER|A_MSG_STORE|A_MSG_PROCESS,
		/* S_POLICY_ENGINE	==> */	A_MSG_STORE|A_MSG_PROCESS,
		/* S_RECOVERY		==> */	A_TICKLE_DC_TIMER|A_MSG_STORE|A_MSG_PROCESS,
		/* S_RECOVERY_DC	==> */	A_MSG_STORE|A_MSG_PROCESS,
		/* S_RELEASE_DC		==> */	A_MSG_STORE|A_MSG_PROCESS,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|A_MSG_STORE|A_MSG_PROCESS,
		/* S_STOPPING		==> */	A_LOG|A_MSG_STORE|A_MSG_PROCESS,
		/* S_TERMINATE		==> */	A_LOG|A_MSG_STORE|A_MSG_PROCESS,
		/* S_TRANSITION_ENGINE	==> */	A_TICKLE_DC_TIMER|A_MSG_STORE|A_MSG_PROCESS,
	},
...
/* Got an I_STARTUP */
	{
		...
		/* S_RECOVERY_DC	==> */	A_WARN,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_STARTING		==> */	A_LOG|A_STARTUP|A_CIB_START|A_LRM_CONNECT|A_CCM_CONNECT|A_HA_CONNECT,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_WARN,
	},
...
/* Got an I_SUCCESS */
	{
		/* S_IDLE		==> */	A_LOG,
		/* S_ELECTION		==> */	A_WARN,
		/* S_INTEGRATION	==> */	A_LOG|A_PE_INVOKE,
		/* S_NOT_DC		==> */	A_NOTHING,
...
/* Got an I_WELCOME */
	{
		/* S_IDLE		==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_ELECTION		==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_INTEGRATION	==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_NOT_DC		==> */	A_TICKLE_DC_TIMER|A_JOIN_ACK,
		/* S_POLICY_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_RECOVERY		==> */	A_TICKLE_DC_TIMER|A_JOIN_ACK,
		/* S_RECOVERY_DC	==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_RELEASE_DC		==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
		/* S_STARTING		==> */	A_TICKLE_DC_TIMER|A_JOIN_ACK|A_STARTED,
		/* S_STOPPING		==> */	A_LOG,
		/* S_TERMINATE		==> */	A_LOG,
		/* S_TRANSITION_ENGINE	==> */	A_TICKLE_DC_TIMER|O_RELEASE|A_JOIN_ACK,
	},

/* Got an I_WELCOME_ACK */
	{
		/* S_IDLE		==> */	A_JOIN_PROCESS_ACK,
		/* S_ELECTION		==> */	A_JOIN_PROCESS_ACK,
