...
/* Got an I_ERROR */
	{
		...
		/* S_HALT		==> */	A_WARN|A_ELECTION_START,
	},
...
/* Got an I_EXIT */
	{
		...
		/* S_INTEGRATION	==> */	A_ERROR|A_SHUTDOWN|O_EXIT,
		/* S_FINALIZE_JOIN	==> */	A_ERROR|A_SHUTDOWN|O_EXIT,
		/* S_NOT_DC		==> */	A_ERROR|A_SHUTDOWN|O_EXIT,
		/* S_POLICY_ENGINE	==> */	A_ERROR|A_SHUTDOWN|O_EXIT,
		/* S_RECOVERY		==> */	A_ERROR|A_SHUTDOWN|O_EXIT,
