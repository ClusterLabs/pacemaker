...
/* Got an I_ERROR */
	{
		/* S_IDLE		==> */	A_RECOVER|O_RELEASE,
		/* S_ELECTION		==> */	A_RECOVER|O_RELEASE,
		/* S_INTEGRATION	==> */	A_RECOVER|O_RELEASE,
		/* S_FINALIZE_JOIN	==> */	A_RECOVER|O_RELEASE,
		/* S_NOT_DC		==> */	A_RECOVER,
		/* S_POLICY_ENGINE	==> */	A_RECOVER|O_RELEASE,
		/* S_RECOVERY		==> */	O_SHUTDOWN|O_RELEASE,
		/* S_RELEASE_DC		==> */	O_SHUTDOWN,
		/* S_STARTING		==> */	O_SHUTDOWN,
		/* S_PENDING		==> */	O_SHUTDOWN,
		/* S_STOPPING		==> */	A_EXIT_1,
		/* S_TERMINATE		==> */	A_EXIT_1,
		/* S_TRANSITION_ENGINE	==> */	A_RECOVER|O_RELEASE,
	},
...
/* Got an I_TERMINATE */
	{
		/* S_IDLE		==> */	O_SHUTDOWN|O_RELEASE,
		/* S_ELECTION		==> */	O_SHUTDOWN|O_RELEASE,
		/* S_INTEGRATION	==> */	O_SHUTDOWN|O_RELEASE,
		/* S_FINALIZE_JOIN	==> */	O_SHUTDOWN|O_RELEASE,
		/* S_NOT_DC		==> */	O_SHUTDOWN,
		/* S_POLICY_ENGINE	==> */	O_SHUTDOWN|O_RELEASE,
		/* S_RECOVERY		==> */	O_SHUTDOWN|O_RELEASE,
		/* S_RELEASE_DC		==> */	O_SHUTDOWN|O_RELEASE,
		/* S_STARTING		==> */	O_SHUTDOWN,
		/* S_PENDING		==> */	O_SHUTDOWN,
		/* S_STOPPING		==> */	O_SHUTDOWN,
		/* S_TERMINATE		==> */	O_SHUTDOWN,
		/* S_TRANSITION_ENGINE	==> */	O_SHUTDOWN|O_RELEASE,
	},
