...
/* Got an I_ERROR */
	{
		/* S_IDLE		==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		/* S_ELECTION		==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		/* S_INTEGRATION	==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		/* S_FINALIZE_JOIN	==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		/* S_NOT_DC		==> */	A_RECOVER,
		/* S_POLICY_ENGINE	==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		...
		/* S_TRANSITION_ENGINE	==> */	A_RECOVER|O_RELEASE|A_ELECTION_START,
		/* S_HALT		==> */	O_SHUTDOWN|A_WARN|A_ELECTION_START,
	},
...
/* Got an I_TERMINATE */
	{
		...
		/* S_HALT		==> */	O_SHUTDOWN|O_RELEASE|A_WARN,
	},
...
/* Got an I_STARTUP */
	{
		...
		/* S_RECOVERY		==> */	A_WARN,
		/* S_RELEASE_DC		==> */	A_WARN,
		/* S_STARTING		==> */	A_LOG|A_STARTUP|A_CIB_START|A_LRM_CONNECT|A_CCM_CONNECT|A_HA_CONNECT|A_READCONFIG|A_STARTED|A_CL_JOIN_QUERY|A_DC_TIMER_START,
		/* S_PENDING		==> */	A_LOG,
		/* S_STOPPING		==> */	A_WARN,
		/* S_TERMINATE		==> */	A_WARN,
		/* S_TRANSITION_ENGINE	==> */	A_WARN,
...
/* Got an I_JOIN_OFFER */
	{
		...
		/* S_NOT_DC		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP|A_DC_TIMER_START,
		/* S_POLICY_ENGINE	==> */	A_CL_JOIN_REQUEST,
		/* S_RECOVERY		==> */	O_RELEASE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP|A_DC_TIMER_START,
		/* S_RELEASE_DC		==> */	A_CL_JOIN_REQUEST|A_DC_TIMER_STOP|A_DC_TIMER_START,
		/* S_STARTING		==> */	A_LOG,
		/* S_PENDING		==> */	O_DC_TICKLE|A_CL_JOIN_REQUEST|A_DC_TIMER_STOP|A_DC_TIMER_START,
		/* S_STOPPING		==> */	A_LOG,
		/* S_TERMINATE		==> */	A_LOG,
...
/* Got an I_PENDING */
	{
		/* S_IDLE		==> */	O_RELEASE,
		/* S_ELECTION		==> */	O_RELEASE|A_DC_TIMER_STOP|A_DC_TIMER_START,
