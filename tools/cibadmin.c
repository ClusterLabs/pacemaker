 ...
 */
typedef struct {
    //! Name of request to send to the CIB API
    const char *cib_request;
} cibadmin_cmd_info_t;
...
main(int argc, char **argv)
{
    ...
    rc = cib_internal_op(cib_conn,
                         cibadmin_command_info[options.cmd].cib_request,
                         options.dest_node, options.cib_section, input, &output,
