...
extern bool promoted_role_only;
...
/* ban */
int cli_resource_prefer(const char *rsc_id, const char *host, cib_t * cib_conn, bool promoted_role_only);
int cli_resource_ban(const char *rsc_id, const char *host, GListPtr allnodes, cib_t * cib_conn, bool promoted_role_only);
int cli_resource_clear(const char *rsc_id, const char *host, GListPtr allnodes, cib_t * cib_conn,
                       bool clear_ban_constraints);
int cli_resource_clear_all_expired(xmlNode *root, cib_t *cib_conn, const char *rsc, const char *node, bool promoted_role_only);
...
int cli_resource_move(pe_resource_t *rsc, const char *rsc_id,
                      ...
                      pe_working_set_t *data_set, bool promoted_role_only);
