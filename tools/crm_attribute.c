...
static GOptionEntry selecting_entries[] = {
    { "all", 'a', G_OPTION_FLAG_NONE, G_OPTION_ARG_NONE, &options.all,
      "Include advanced and deprecated options in the\n"
      INDENT "output\n"
      INDENT "(with -L/--list-options)",
      NULL,
    },

    { "id", 'i', 0, G_OPTION_ARG_STRING, &options.attr_id,
      "(Advanced) Operate on instance of specified\n"
      INDENT "attribute with this XML ID",
      "XML_ID"
    },
    ...
    { "promotion", 'p', G_OPTION_FLAG_OPTIONAL_ARG, G_OPTION_ARG_CALLBACK, promotion_cb,
      "Operate on node attribute used as promotion score\n"
      INDENT "for specified resource",
      "RESOURCE"
    },
...
static GOptionEntry command_entries[] = {
    { "list-options", 'L', G_OPTION_FLAG_NONE, G_OPTION_ARG_CALLBACK, list_cb,
      ...
      INDENT "Values: '" PCMK__VALUE_CLUSTER "'",
      "TYPE"
    },
...
static GOptionEntry addl_entries[] = {
    { "default", 'd', 0, G_OPTION_ARG_STRING, &options.attr_default,
      "(Advanced) Default value to display if none is\n"
      INDENT "found in configuration",
      "VALUE"
    },

    { "lifetime", 'l', 0, G_OPTION_ARG_STRING, &options.type,
      "Lifetime of the node attribute\n"
      INDENT "Values: 'forever', 'reboot'",
      "LIFETIME"
    },
    ...
    { "type", 't', 0, G_OPTION_ARG_STRING, &options.type,
      "Which part of the configuration to update, delete,\n"
      INDENT "or query the option in\n"
      INDENT "Values: 'crm_config', 'rsc_defaults',\n"
      INDENT "        'op_defaults', 'tickets'",
      "SECTION"
    },
    ...
    { "wait", 'W', 0, G_OPTION_ARG_CALLBACK, wait_cb,
      ...
      INDENT "(with -N, and one of -D or -v)",
      "UNTIL" },
