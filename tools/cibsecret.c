 ...
 */
typedef int (*rsh_fn_t)(pcmk__output_t *out, gchar **nodes, char **argv);
...
static int
pssh(pcmk__output_t *out, gchar **nodes, char **cmd)
{
    int rc = pcmk_rc_ok;
...
static int
pdsh(pcmk__output_t *out, gchar **nodes, char **cmd)
{
    int rc = pcmk_rc_ok;
    int cmd_len = g_strv_length(cmd);
...
static int
ssh(pcmk__output_t *out, gchar **nodes, char **cmd)
{
    int cmd_len = g_strv_length(cmd);
