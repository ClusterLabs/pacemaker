...
static void print_nvpair(FILE *stream, mon_output_format_t output_format,
                         const char *name, const char *value, const char *units,
                         time_t epoch_time);
static void print_node_start(FILE *stream, mon_output_format_t output_format,
                             node_t *node, unsigned int mon_ops);
static void print_node_end(FILE *stream, mon_output_format_t output_format);
static void print_resources_heading(FILE *stream, mon_output_format_t output_format,
                                    unsigned int mon_ops);
static void print_resources_closing(FILE *stream, mon_output_format_t output_format,
                                    gboolean printed_heading, unsigned int mon_ops);
static void print_resources(FILE *stream, mon_output_format_t output_format,
                            pe_working_set_t *data_set, int print_opts,
                            unsigned int mon_ops);
static void print_rsc_history_start(FILE *stream, mon_output_format_t output_format,
                                    pe_working_set_t *data_set, node_t *node,
                                    resource_t *rsc, const char *rsc_id, gboolean all);
static void print_rsc_history_end(FILE *stream, mon_output_format_t output_format);
static void print_op_history(FILE *stream, mon_output_format_t output_format,
                             pe_working_set_t *data_set, node_t *node, xmlNode *xml_op,
                             const char *task, const char *interval_ms_s, int rc,
                             unsigned int mon_ops);
static void print_rsc_history(FILE *stream, mon_output_format_t output_format,
                              pe_working_set_t *data_set, node_t *node,
                              xmlNode *rsc_entry, gboolean operations,
                              unsigned int mon_ops);
static void print_node_history(FILE *stream, mon_output_format_t output_format,
                               pe_working_set_t *data_set, xmlNode *node_state,
                               gboolean operations, unsigned int mon_ops);
static gboolean print_attr_msg(FILE *stream, mon_output_format_t output_format,
                               node_t * node, GListPtr rsc_list, const char *attrname,
                               const char *attrvalue);
static void print_node_attribute(gpointer name, gpointer user_data);
static void print_node_summary(FILE *stream, mon_output_format_t output_format,
                               pe_working_set_t * data_set, gboolean operations,
                               unsigned int mon_ops);
static void print_ticket(gpointer name, gpointer value, gpointer user_data);
static void print_cluster_tickets(FILE *stream, mon_output_format_t output_format,
                                  pe_working_set_t * data_set);
static void print_ban(FILE *stream, mon_output_format_t output_format,
                      pe_node_t *node, pe__location_t *location, unsigned int mon_ops);
static void print_neg_locations(FILE *stream, mon_output_format_t output_format,
                                pe_working_set_t *data_set, unsigned int mon_ops,
                                const char *prefix);
static void print_node_attributes(FILE *stream, mon_output_format_t output_format,
                                  pe_working_set_t *data_set, unsigned int mon_ops);
static void print_cluster_summary_header(FILE *stream, mon_output_format_t output_format);
static void print_cluster_summary_footer(FILE *stream, mon_output_format_t output_format);
static void print_cluster_times(FILE *stream, mon_output_format_t output_format,
                                pe_working_set_t *data_set);
static void print_cluster_stack(FILE *stream, mon_output_format_t output_format,
                                const char *stack_s);
static void print_cluster_dc(FILE *stream, mon_output_format_t output_format,
                             pe_working_set_t *data_set, unsigned int mon_ops);
static void print_cluster_counts(FILE *stream, mon_output_format_t output_format,
                                 pe_working_set_t *data_set, const char *stack_s);
static void print_cluster_options(FILE *stream, mon_output_format_t output_format,
                                  pe_working_set_t *data_set);
static void print_cluster_summary(FILE *stream, mon_output_format_t output_format,
                                  pe_working_set_t *data_set, unsigned int mon_ops,
                                  unsigned int show);
static void print_failed_action(FILE *stream, mon_output_format_t output_format,
                                xmlNode *xml_op);
static void print_failed_actions(FILE *stream, mon_output_format_t output_format,
                                 pe_working_set_t *data_set);
static void print_stonith_action(FILE *stream, mon_output_format_t output_format,
                                 stonith_history_t *event, unsigned int mon_ops);
static void print_failed_stonith_actions(FILE *stream, mon_output_format_t output_format,
                                         stonith_history_t *history, unsigned int mon_ops);
static void print_stonith_pending(FILE *stream, mon_output_format_t output_format,
                                  stonith_history_t *history, unsigned int mon_ops);
static void print_stonith_history(FILE *stream, mon_output_format_t output_format,
                                  stonith_history_t *history, unsigned int mon_ops);
 ...
 */
static void
print_nvpair(FILE *stream, mon_output_format_t output_format, const char *name,
             const char *value, const char *units, time_t epoch_time)
{
    /* print name= */
 ...
 */
static void
print_node_start(FILE *stream, mon_output_format_t output_format, node_t *node,
                 unsigned int mon_ops)
{
    char *node_name;
 ...
 */
static void
print_node_end(FILE *stream, mon_output_format_t output_format)
{
    switch (output_format) {
        case mon_output_html:
        case mon_output_cgi:
 ...
 */
static void
print_resources_heading(FILE *stream, mon_output_format_t output_format,
                        unsigned int mon_ops)
{
    const char *heading;
 ...
 */
static void
print_resources_closing(FILE *stream, mon_output_format_t output_format,
                        gboolean printed_heading, unsigned int mon_ops)
{
    const char *heading;
 ...
 */
static void
print_resources(FILE *stream, mon_output_format_t output_format,
                pe_working_set_t *data_set, int print_opts, unsigned int mon_ops)
{
    GListPtr rsc_iter;
    ...
    if (brief_output && is_not_set(mon_ops, mon_op_group_by_node)) {
        print_resources_heading(stream, output_format, mon_ops);
    ...
    print_resources_closing(stream, output_format, printed_heading, mon_ops);
}
 ...
 */
static void
print_rsc_history_start(FILE *stream, mon_output_format_t output_format,
                        pe_working_set_t *data_set, node_t *node, resource_t *rsc,
                        const char *rsc_id, gboolean all)
{
    ...
    /* If resource is not an orphan, print some details */
        ...
        if (last_failure > 0) {
            print_nvpair(stream, output_format, CRM_LAST_FAILURE_PREFIX, NULL, NULL,
                         last_failure);
        }
    }
 ...
 */
static void
print_rsc_history_end(FILE *stream, mon_output_format_t output_format)
{
    switch (output_format) {
        case mon_output_html:
        case mon_output_cgi:
 ...
 */
static void
print_op_history(FILE *stream, mon_output_format_t output_format, 
                 pe_working_set_t *data_set, node_t *node, xmlNode *xml_op,
                 const char *task, const char *interval_ms_s, int rc,
                 unsigned int mon_ops)
{
    ...
    if (interval_ms_s && safe_str_neq(interval_ms_s, "0")) {
        print_nvpair(stream, output_format, "interval", interval_ms_s, "ms", 0);
    }
    if (is_set(mon_ops, mon_op_print_timing)) {
        ...
        if (value) {
            ...
            if (int_value > 0) {
                print_nvpair(stream, output_format, attr, NULL, NULL, int_value);
            }
        }
        ...
        value = crm_element_value(xml_op, attr);
        if (value) {
            print_nvpair(stream, output_format, attr, value, "ms", 0);
        }
 ...
 */
static void
print_rsc_history(FILE *stream, mon_output_format_t output_format,
                  pe_working_set_t *data_set, node_t *node, xmlNode *rsc_entry,
                  gboolean operations, unsigned int mon_ops)
{
    GListPtr gIter = NULL;
    ...
    if (operations == FALSE) {
        print_rsc_history_start(stream, output_format, data_set, node, rsc, rsc_id, FALSE);
        print_rsc_history_end(stream, output_format);
        return;
    }
    ...
    for (gIter = op_list; gIter != NULL; gIter = gIter->next) {
        ...
        if (printed == FALSE) {
            printed = TRUE;
            print_rsc_history_start(stream, output_format, data_set, node, rsc, rsc_id, TRUE);
        }

        /* Print the operation */
        print_op_history(stream, output_format, data_set, node, xml_op, task, interval_ms_s,
                         rc, mon_ops);
    }
 ...
 */
static void
print_node_history(FILE *stream, mon_output_format_t output_format,
                   pe_working_set_t *data_set, xmlNode *node_state,
                   gboolean operations, unsigned int mon_ops)
{
    ...
    if (node && node->details && node->details->online) {
        print_node_start(stream, output_format, node, mon_ops);
        ...
        for (rsc_entry = __xml_first_child(lrm_rsc); rsc_entry != NULL;
            ...
            if (crm_str_eq((const char *)rsc_entry->name, XML_LRM_TAG_RESOURCE, TRUE)) {
                print_rsc_history(stream, output_format, data_set, node, rsc_entry, operations, mon_ops);
            }
        }

        print_node_end(stream, output_format);
    }
}
 ...
 */
static gboolean
print_attr_msg(FILE *stream, mon_output_format_t output_format, node_t * node,
               GListPtr rsc_list, const char *attrname, const char *attrvalue)
{
    GListPtr gIter = NULL;
    ...
    for (gIter = rsc_list; gIter != NULL; gIter = gIter->next) {
        ...
        if (rsc->children != NULL) {
            if (print_attr_msg(stream, output_format, node, rsc->children, attrname, attrvalue)) {
                return TRUE;
            }
        }
...
print_node_attribute(gpointer name, gpointer user_data)
{
    ...
    print_attr_msg(data->stream, data->fmt, data->node, data->node->details->running_rsc,
                   name, value);
...
static void
print_node_summary(FILE *stream, mon_output_format_t output_format,
                   pe_working_set_t * data_set, gboolean operations,
                   unsigned int mon_ops)
{
    ...
    for (node_state = __xml_first_child(cib_status); node_state != NULL;
        ...
        if (crm_str_eq((const char *)node_state->name, XML_CIB_TAG_STATE, TRUE)) {
            print_node_history(stream, output_format, data_set, node_state, operations, mon_ops);
        }
    }
...
print_ticket(gpointer name, gpointer value, gpointer user_data)
{
    ...
    if (ticket->last_granted > -1) {
        print_nvpair(stdout, data->fmt, "last-granted", NULL, NULL, ticket->last_granted);
    }
    switch (data->fmt) {
        case mon_output_plain:
        case mon_output_console:
...
static void
print_cluster_tickets(FILE *stream, mon_output_format_t output_format,
                      pe_working_set_t * data_set)
{
 ...
 */
static void
print_ban(FILE *stream, mon_output_format_t output_format, pe_node_t *node,
          pe__location_t *location, unsigned int mon_ops)
{
    char *node_name = NULL;
 ...
 */
static void
print_neg_locations(FILE *stream, mon_output_format_t output_format,
                    pe_working_set_t *data_set, unsigned int mon_ops,
                    const char *prefix)
{
    ...
    for (gIter = data_set->placement_constraints; gIter != NULL; gIter = gIter->next) {
        ...
        for (gIter2 = location->node_list_rh; gIter2 != NULL; gIter2 = gIter2->next) {
            ...
            if (node->weight < 0) {
                print_ban(stream, output_format, node, location, mon_ops);
            }
        }
    }
 ...
 */
static void
print_node_attributes(FILE *stream, mon_output_format_t output_format,
                      pe_working_set_t *data_set, unsigned int mon_ops)
{
    GListPtr gIter = NULL;
    ...
    for (gIter = data_set->nodes; gIter != NULL; gIter = gIter->next) {
        ...
        if (data.node && data.node->details && data.node->details->online) {
            ...
            print_node_start(stream, output_format, data.node, mon_ops);
 ...
 */
static void
print_cluster_summary_header(FILE *stream, mon_output_format_t output_format)
{
    switch (output_format) {
        case mon_output_html:
        case mon_output_cgi:
 ...
 */
static void
print_cluster_summary_footer(FILE *stream, mon_output_format_t output_format)
{
    switch (output_format) {
        case mon_output_cgi:
        case mon_output_html:
 ...
 */
static void
print_cluster_times(FILE *stream, mon_output_format_t output_format,
                    pe_working_set_t *data_set)
{
 ...
 */
static void
print_cluster_stack(FILE *stream, mon_output_format_t output_format,
                    const char *stack_s)
{
    switch (output_format) {
        case mon_output_plain:
 ...
 */
static void
print_cluster_dc(FILE *stream, mon_output_format_t output_format,
                 pe_working_set_t *data_set, unsigned int mon_ops)
{
 ...
 */
static void
print_cluster_counts(FILE *stream, mon_output_format_t output_format,
                     pe_working_set_t *data_set, const char *stack_s)
{
 ...
 */
static void
print_cluster_options(FILE *stream, mon_output_format_t output_format,
                      pe_working_set_t *data_set)
{
    switch (output_format) {
        case mon_output_plain:
 ...
 */
static void
print_cluster_summary(FILE *stream, mon_output_format_t output_format,
                      pe_working_set_t *data_set, unsigned int mon_ops,
                      unsigned int show)
{
    ...
    if (show & mon_show_stack) {
        if (header_printed == FALSE) {
            print_cluster_summary_header(stream, output_format);
            header_printed = TRUE;
        }
        print_cluster_stack(stream, output_format, stack_s);
    }
    ...
    if ((data_set->dc_node == NULL) || (show & mon_show_dc)) {
        ...
        print_cluster_dc(stream, output_format, data_set, mon_ops);
    }
    ...
    if (show & mon_show_times) {
        ...
        print_cluster_times(stream, output_format, data_set);
    }
    ...
    if (is_set(data_set->flags, pe_flag_maintenance_mode)
        ...
        print_cluster_counts(stream, output_format, data_set, stack_s);
    }
     ...
     */
    if (show & mon_show_stack) {
        print_cluster_options(stream, output_format, data_set);
    }

    if (header_printed) {
        print_cluster_summary_footer(stream, output_format);
    }
}
 ...
 */
static void
print_failed_action(FILE *stream, mon_output_format_t output_format,
                    xmlNode *xml_op)
{
 ...
 */
static void
print_failed_actions(FILE *stream, mon_output_format_t output_format,
                     pe_working_set_t *data_set)
{
    xmlNode *xml_op = NULL;
    ...
    for (xml_op = __xml_first_child(data_set->failed); xml_op != NULL;
        ...
        print_failed_action(stream, output_format, xml_op);
    }
 ...
 */
static void
print_stonith_action(FILE *stream, mon_output_format_t output_format,
                     stonith_history_t *event, unsigned int mon_ops)
{
 ...
 */
static void
print_failed_stonith_actions(FILE *stream, mon_output_format_t output_format,
                             stonith_history_t *history, unsigned int mon_ops)
{
    ...
    for (hp = history; hp; hp = hp->next) {
        if (hp->state == st_failed) {
            print_stonith_action(stream, output_format, hp, mon_ops);
        }
    }
 ...
 */
static void
print_stonith_pending(FILE *stream, mon_output_format_t output_format,
                      stonith_history_t *history, unsigned int mon_ops)
{
 ...
 */
static void
print_stonith_history(FILE *stream, mon_output_format_t output_format,
                      stonith_history_t *history, unsigned int mon_ops)
{
    stonith_history_t *hp;
...
void
print_status(mon_output_format_t output_format, pe_working_set_t *data_set,
             ...
             unsigned int show, const char *prefix)
{
    ...
    print_cluster_summary(stdout, output_format, data_set, mon_ops, show);
    print_as(output_format, "\n");
    ...
    print_resources(stdout, output_format, data_set, print_opts, mon_ops);

    /* print Node Attributes section if requested */
    if (show & mon_show_attributes) {
        print_node_attributes(stdout, output_format, data_set, mon_ops);
    }
    ...
    if (show & (mon_show_operations | mon_show_failcounts)) {
        print_node_summary(stdout, output_format, data_set,
                           ((show & mon_show_operations)? TRUE : FALSE), mon_ops);
    }

    /* If there were any failed actions, print them */
    if (xml_has_children(data_set->failed)) {
        print_failed_actions(stdout, output_format, data_set);
    }

    /* Print failed stonith actions */
    if (is_set(mon_ops, mon_op_fence_history)) {
        print_failed_stonith_actions(stdout, output_format, stonith_history, mon_ops);
    }

    /* Print tickets if requested */
    if (show & mon_show_tickets) {
        print_cluster_tickets(stdout, output_format, data_set);
    }

    /* Print negative location constraints if requested */
    if (show & mon_show_bans) {
        print_neg_locations(stdout, output_format, data_set, mon_ops, prefix);
    }

    /* Print stonith history */
    if (is_set(mon_ops, mon_op_fence_history)) {
        if (show & mon_show_fence_history) {
            print_stonith_history(stdout, output_format, stonith_history, mon_ops);
        } else {
            print_stonith_pending(stdout, output_format, stonith_history, mon_ops);
        }
    }
...
void
print_xml_status(mon_output_format_t output_format, pe_working_set_t *data_set,
                 stonith_history_t *stonith_history, unsigned int mon_ops,
                 unsigned int show, const char *prefix)
{
    FILE *stream = stdout;
    ...
    print_cluster_summary(stream, output_format, data_set, mon_ops, show);
    ...
    /* Print resources section, if needed */
    print_resources(stream, output_format, data_set, print_opts, mon_ops);

    /* print Node Attributes section if requested */
    if (show & mon_show_attributes) {
        print_node_attributes(stream, output_format, data_set, mon_ops);
    }
     ...
     */
    if (show & (mon_show_operations | mon_show_failcounts)) {
        print_node_summary(stream, output_format, data_set,
                           ((show & mon_show_operations)? TRUE : FALSE), mon_ops);
    }

    /* If there were any failed actions, print them */
    if (xml_has_children(data_set->failed)) {
        print_failed_actions(stream, output_format, data_set);
    }
    ...
    /* Print tickets if requested */
    if (show & mon_show_tickets) {
        print_cluster_tickets(stream, output_format, data_set);
    }

    /* Print negative location constraints if requested */
    if (show & mon_show_bans) {
        print_neg_locations(stream, output_format, data_set, mon_ops, prefix);
    }
...
int
print_html_status(mon_output_format_t output_format, pe_working_set_t *data_set,
                  ...
                  unsigned int reconnect_msec)
{
    ...
    /* Print failed stonith actions */
    if (is_set(mon_ops, mon_op_fence_history)) {
        print_failed_stonith_actions(stream, output_format, stonith_history, mon_ops);
    }

    /* Print stonith history */
    if (is_set(mon_ops, mon_op_fence_history)) {
        if (show & mon_show_fence_history) {
            print_stonith_history(stream, output_format, stonith_history, mon_ops);
        } else {
            print_stonith_pending(stdout, output_format, stonith_history, mon_ops);
        }
    }
