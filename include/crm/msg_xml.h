...
#  define XML_COLOC_ATTR_SOURCE_VERSION		"rsc-version"
#  define XML_COLOC_ATTR_SOURCE_OPERATION	"rsc-op"
#  define XML_COLOC_ATTR_TARGET		"with-rsc"
#  define XML_COLOC_ATTR_TARGET_ROLE	"with-rsc-role"
#  define XML_COLOC_ATTR_TARGET_VERSION		"with-rsc-version"
#  define XML_COLOC_ATTR_TARGET_OPERATION	"with-rsc-op"
...
#  define XML_ORDER_ATTR_FIRST_VERSION		"first-version"
#  define XML_ORDER_ATTR_THEN_VERSION		"then-version"
#  define XML_ORDER_ATTR_FIRST_OPERATION	"first-op"
#  define XML_ORDER_ATTR_THEN_OPERATION         "then-op"
