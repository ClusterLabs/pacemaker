...
do_test bug-5014-A-start-B-start "Issue #5014 - symmetric=false. Verify when A starts B starts."
do_test bug-5014-A-stop-B-started "Issue #5014 - symmetric=false. Verify when A stops B does not stop if it has already started."
do_test bug-5014-A-stopped-B-stopped "Issue #5014 - symmetric=false. Verify when A is stopped and B has not started, B does not start before A."
do_test bug-5014-CthenAthenB-C-stopped " #5014 Verify when C then A is symmetrical=true, A then B is symmetrical=false, and C is stopped that nothing starts."
do_test bug-5014-CLONE-A-start-B-start "Issue #5014 - symmetric=false. Verify when A starts B starts."
do_test bug-5014-CLONE-A-stop-B-started "Issue #5014 - symmetric=false. Verify when A stops B does not stop if it has already started."
do_test bug-5014-GROUP-A-start-B-start "Issue #5014 - symmetric=false. Verify when A starts B starts."
do_test bug-5014-GROUP-A-stopped-B-started "Issue #5014 - symmetric=false. Verify when A stops B does not stop if it has already started."
do_test bug-5014-GROUP-A-stopped-B-stopped "Issue #5014 - symmetric=false. Verify when A is stopped and B has not started, B does not start before A."
