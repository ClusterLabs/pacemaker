...
echo ""
do_test stopped-monitor-00-initial-start		"Stopped Monitor - initial start"
do_test stopped-monitor-01-failed-started		"Stopped Monitor - failed started"
do_test stopped-monitor-02-started-multi-up		"Stopped Monitor - started multi-up"
do_test stopped-monitor-03-stop-started			"Stopped Monitor - stop started"
do_test stopped-monitor-04-failed-stop			"Stopped Monitor - failed stop"
do_test stopped-monitor-05-start-unmanaged		"Stopped Monitor - start unmanaged"
do_test stopped-monitor-06-unmanaged-multi-up		"Stopped Monitor - unmanaged multi-up"
do_test stopped-monitor-07-start-unmanaged-multi-up	"Stopped Monitor - start unmanaged multi-up"
do_test stopped-monitor-08-migrate			"Stopped Monitor - migrate"
do_test stopped-monitor-09-unmanage-started		"Stopped Monitor - unmanage started"
do_test stopped-monitor-10-unmanaged-started-multi-up	"Stopped Monitor - unmanaged started multi-up"
do_test stopped-monitor-11-stop-unmanaged-started	"Stopped Monitor - stop unmanaged started"
do_test stopped-monitor-12-unmanaged-started-multi-up	"Stopped Monitor - unmanaged started multi-up (targer-role="Stopped")"
do_test stopped-monitor-20-initial-stop			"Stopped Monitor - initial stop"
do_test stopped-monitor-21-stopped-single-up		"Stopped Monitor - stopped single-up"
do_test stopped-monitor-22-stopped-multi-up		"Stopped Monitor - stopped multi-up"
do_test stopped-monitor-23-start-stopped		"Stopped Monitor - start stopped"
do_test stopped-monitor-24-unmanage-stopped		"Stopped Monitor - unmanage stopped"
do_test stopped-monitor-25-unmanaged-stopped-multi-up	"Stopped Monitor - unmanaged stopped multi-up"
do_test stopped-monitor-26-start-unmanaged-stopped	"Stopped Monitor - start unmanaged stopped"
do_test stopped-monitor-27-unmanaged-stopped-multi-up	"Stopped Monitor - unmanaged stopped multi-up (target-role="Started")"
do_test stopped-monitor-30-new-node-started		"Stopped Monitor - new node started"
do_test stopped-monitor-31-new-node-stopped		"Stopped Monitor - new node stopped"

echo""
do_test ticket-primitive-stop-1-initial "Ticket - Primitive (loss-policy=stop, initial)"
do_test ticket-primitive-stop-2-granted "Ticket - Primitive (loss-policy=stop, granted)"
do_test ticket-primitive-stop-3-revoked "Ticket - Primitive (loss-policy-stop, revoked)"
do_test ticket-primitive-demote-1-initial "Ticket - Primitive (loss-policy=demote, initial)"
do_test ticket-primitive-demote-2-granted "Ticket - Primitive (loss-policy=demote, granted)"
do_test ticket-primitive-demote-3-revoked "Ticket - Primitive (loss-policy=demote, revoked)"
do_test ticket-primitive-fence-1-initial "Ticket - Primitive (loss-policy=fence, initial)"
do_test ticket-primitive-fence-2-granted "Ticket - Primitive (loss-policy=fence, granted)"
do_test ticket-primitive-fence-3-revoked "Ticket - Primitive (loss-policy=fence, revoked)"
do_test ticket-primitive-freeze-1-initial "Ticket - Primitive (loss-policy=freeze, initial)"
do_test ticket-primitive-freeze-2-granted "Ticket - Primitive (loss-policy=freeze, granted)"
do_test ticket-primitive-freeze-3-revoked "Ticket - Primitive (loss-policy=freeze, revoked)"
  
do_test ticket-group-stop-1-initial "Ticket - Group (loss-policy=stop, initial)"
do_test ticket-group-stop-2-granted "Ticket - Group (loss-policy=stop, granted)"
do_test ticket-group-stop-3-revoked "Ticket - Group (loss-policy=stop, revoked)"
do_test ticket-group-demote-1-initial "Ticket - Group (loss-policy=demote, initial)"
do_test ticket-group-demote-2-granted "Ticket - Group (loss-policy=demote, granted)"
do_test ticket-group-demote-3-revoked "Ticket - Group (loss-policy=demote, revoked)"
do_test ticket-group-fence-1-initial "Ticket - Group (loss-policy=fence, initial)"
do_test ticket-group-fence-2-granted "Ticket - Group (loss-policy=fence, granted)"
do_test ticket-group-fence-3-revoked "Ticket - Group (loss-policy=fence, revoked)"
do_test ticket-group-freeze-1-initial "Ticket - Group (loss-policy=freeze, initial)"
do_test ticket-group-freeze-2-granted "Ticket - Group (loss-policy=freeze, granted)"
do_test ticket-group-freeze-3-revoked "Ticket - Group (loss-policy=freeze, revoked)"
  
do_test ticket-clone-stop-1-initial "Ticket - Clone (loss-policy=stop, initial)"
do_test ticket-clone-stop-2-granted "Ticket - Clone (loss-policy=stop, granted)"
do_test ticket-clone-stop-3-revoked "Ticket - Clone (loss-policy=stop, revoked)"
do_test ticket-clone-demote-1-initial "Ticket - Clone (loss-policy=demote, initial)"
do_test ticket-clone-demote-2-granted "Ticket - Clone (loss-policy=demote, granted)"
do_test ticket-clone-demote-3-revoked "Ticket - Clone (loss-policy=demote, revoked)"
do_test ticket-clone-fence-1-initial "Ticket - Clone (loss-policy=fence, initial)"
do_test ticket-clone-fence-2-granted "Ticket - Clone (loss-policy=fence, granted)"
do_test ticket-clone-fence-3-revoked "Ticket - Clone (loss-policy=fence, revoked)"
do_test ticket-clone-freeze-1-initial "Ticket - Clone (loss-policy=freeze, initial)"
do_test ticket-clone-freeze-2-granted "Ticket - Clone (loss-policy=freeze, granted)"
do_test ticket-clone-freeze-3-revoked "Ticket - Clone (loss-policy=freeze, revoked)"

do_test ticket-master-stop-1-initial "Ticket - Master (loss-policy=stop, initial)"
do_test ticket-master-stop-2-granted "Ticket - Master (loss-policy=stop, granted)"
do_test ticket-master-stop-3-revoked "Ticket - Master (loss-policy=stop, revoked)"
do_test ticket-master-demote-1-initial "Ticket - Master (loss-policy=demote, initial)"
do_test ticket-master-demote-2-granted "Ticket - Master (loss-policy=demote, granted)"
do_test ticket-master-demote-3-revoked "Ticket - Master (loss-policy=demote, revoked)"
do_test ticket-master-fence-1-initial "Ticket - Master (loss-policy=fence, initial)"
do_test ticket-master-fence-2-granted "Ticket - Master (loss-policy=fence, granted)"
do_test ticket-master-fence-3-revoked "Ticket - Master (loss-policy=fence, revoked)"
do_test ticket-master-freeze-1-initial "Ticket - Master (loss-policy=freeze, initial)"
do_test ticket-master-freeze-2-granted "Ticket - Master (loss-policy=freeze, granted)"
do_test ticket-master-freeze-3-revoked "Ticket - Master (loss-policy=freeze, revoked)"
