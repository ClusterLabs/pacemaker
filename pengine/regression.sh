...
do_test colo_master_w_clone_1 "Ensure master rsc stays placed on node with active clone rsc."
do_test colo_master_w_clone_2 "Ensure master rsc stays placed on node with active clone rsc, colocation args switched."
do_test colo_master_w_native_1 "Ensure master rsc stays placed on node with native rsc"
do_test colo_master_w_native_2 "Ensure master rsc stays placed on node with native rsc, colocation args switched."
do_test colo_master_w_native_3 "Ensure master rsc stays placed on node with native rsc with native rsc stickiness preventing native to move."
