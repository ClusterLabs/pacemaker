...
{
    // See @COMPAT and @TODO comments in pcmk__xe_replace_match()
...
{
    /* @COMPAT Is pcmk__apply_acl() enough to properly consider ACLs?
     *
...
{
    /* @COMPAT In pcmk__xe_replace_match() and pcmk__xe_replace_match(), we
