...
static const pcmk__cluster_option_t cluster_options[] = {
    ...
    {   PCMK_OPT_FENCE_REMOTE_WITHOUT_QUORUM, NULL, PCMK_VALUE_BOOLEAN, NULL,
         ...
         "Experimental",
         "By default, inquorate nodes can fence Pacemaker Remote nodes that "
             "are part of its partition regardless of whether the resource "
             "was successfully restarted elsewhere.  If false, an experimental "
             "additional check will be added to only fence remote nodes if "
             "the cluster thinks they were unable to be restarted."
     },
    {
