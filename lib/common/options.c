...
static const pcmk__cluster_option_t cluster_options[] = {
    ...
    {
        PCMK_OPT_STONITH_TIMEOUT, NULL, PCMK_VALUE_TIMEOUT, NULL,
...
static const pcmk__cluster_option_t fence_params[] = {
    /* name, old name, type, allowed values,
     * default value, validator,
     * flags,
     * short description,
 ...
 */
int
pcmk__output_fence_params(pcmk__output_t *out, const char *name,
                          const char *desc_short, const char *desc_long,
                          bool all)
{
    return out->message(out, "option-list", name, desc_short, desc_long,
                        pcmk__opt_none, fence_params, all);
}
                      ...
                      enum pcmk__opt_flags filter)
{
    ...
    if (filter == pcmk__opt_fencer) {
        pcmk__output_fence_params(tmp_out, name, desc_short, desc_long, true);
    } else {
