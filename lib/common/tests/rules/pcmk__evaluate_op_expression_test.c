...
null_invalid(void **state)
{
    ...
    xml = pcmk__xml_parse(EXPR_NO_MATCH);
...
static void
reference_name_missing(void **state)
{
    rule_input.op_name = NULL;
    assert_op_expression(EXPR_ALL_MATCH, pcmk_rc_op_unsatisfied);
...
{
    assert_op_expression(EXPR_ALL_MATCH, pcmk_rc_ok);
}
...
PCMK__UNIT_TEST(NULL, NULL,
                ...
                cmocka_unit_test(reference_name_missing),
