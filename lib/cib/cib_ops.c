                   ...
                   xmlNode **result_cib, xmlNode **answer)
{
    ...
    /* Copying is a wasteful here, but calling pcmk__xml_copy() adds the copy as
     * a child of the existing *result_cib within the same document. This
     * reduces the number of opportunities to make mistakes related to XML
     * documents, change tracking, etc., compared to calling xmlUnlinkChild(),
     * xmlAddChild(), etc.
     */
