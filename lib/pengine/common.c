...
pe_cluster_option pe_opts[] = {
	...
	{ "actions-limit", NULL, "integer", NULL, "0", &check_number,
	  ...
	  "If set to zero or unset, defaults to at least 4 or twice the number of CPU cores on the DC. -1 means unlimited."},
	{ "migration-limit", NULL, "integer", NULL, "0", &check_number,
	  ...
	  "If set to zero or unset, defaults to half the number of CPU cores on the DC. -1 means unlimited."},
