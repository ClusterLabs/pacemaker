...
lrmd_event_data_t *lrmd_copy_event(lrmd_event_data_t *event)
{
	...
	crm_malloc0(copy, sizeof(lrmd_event_data_t));
...
void lrmd_free_event(lrmd_event_data_t *event)
{
	...
	/* crm_free gives me grief if i try to cast */
...
lrmd_rsc_info_t *lrmd_copy_rsc_info(lrmd_rsc_info_t *rsc_info)
{
	...
	crm_malloc0(copy, sizeof(lrmd_rsc_info_t));
...
void lrmd_free_rsc_info(lrmd_rsc_info_t *rsc_info)
{
	...
	crm_free(rsc_info->id);
	crm_free(rsc_info->type);
	crm_free(rsc_info->class);
	crm_free(rsc_info->provider);
	crm_free(rsc_info);
}

static lrmd_rsc_info_t *
lrmd_api_get_rsc_info(lrmd_t *lrmd,
	const char *rsc_id,
	enum lrmd_call_options options)
{
	int rc = lrmd_ok;
	...
	crm_malloc0(rsc_info, sizeof(lrmd_rsc_info_t));
...
static int
lrmd_api_list_agents(lrmd_t *lrmd, lrmd_list_t **resources, const char *class, const char *provider)
{
	int rc = lrmd_ok;
