...
static crm_child_t pcmk_children[] = {
    ...
    { 0, crm_proc_stonithd, crm_flag_none,    0, 0, TRUE,  "stonithd", NULL,       CRM_DAEMON_DIR"/stonithd", NULL, NULL },
    ...
    { 0, crm_proc_stonith_ng, crm_flag_none,  1, 0, TRUE,  "stonith-ng", NULL,     CRM_DAEMON_DIR"/stonith-ng", NULL, NULL },
};
