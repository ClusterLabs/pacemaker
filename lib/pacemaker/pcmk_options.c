 ...
 */
int
pcmk__list_fence_params(pcmk__output_t *out, bool all)
{
    ...
    return pcmk__output_fence_params(out, name, desc_short, desc_long, all);
}

// Documented in header
int
pcmk_list_fence_params(xmlNode **xml, bool all)
{
    pcmk__output_t *out = NULL;
    int rc = pcmk_rc_ok;
    ...
    rc = pcmk__list_fence_params(out, all);
